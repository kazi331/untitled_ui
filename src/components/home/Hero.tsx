  ...
  return (
    <div className="bg-brand pt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  overflow-hidden">
        ...
        <p className="text-4xl sm:text-5xl lg:text-7xl text-white font-extrabold sm:w-2/3  max-w-3xl mx-auto my-8 ">
          Banking technology that has your back.
        </p>
        <p className="text-[#E9D7FE] text-center mx-auto sm:w-2/3  max-w-3xl">
